Public Class LiquidacionRemision
    ...
    Private _Totalizador As Double
    Private TotalContado As Double
    Private TotalCredito As Double
    Private TotalImporte As Double
    Private _PrecioMalo As String
    ...
    Public Sub Entrada(ByVal Fecha As Date, _
        ...
        Else
            ...
            _Totalizador = CType(DsLiquidacion.Operador(0).LitrosLiquidados, Double)
            _Fecha = Fecha

            'TODO: El caption de la forma desplegaría el total de litros a liquidar y el folio

            Me.Text &= " Folio: " & _Folio & " Litros a liquidar: " & _Totalizador
            ...
            Try
                ...
                DsLiquidacion.TipoPago.AddTipoPagoRow(5, "Credito Empresa")
                'Cambio de desc. de tipo de pago de "Credito GM" a "Credito Empresa"
...
#Region "Sin revisar"
    Private Function ValidarPrecios() As Boolean
        ...
        'TODO: Se desactivo para permitir la liquidacion con múltiples precios 24112004 Flama Azul JAGD
        ...
        '        Regreso = True
        '        _PrecioMalo = CType(lstPrecio2.Items(i), String)
        '    End If
        'Next
        ...
        '        Regreso = True
        '        _PrecioMalo = CType(lstPrecio.Items(i), String)
        '    End If
        'Next

        Dim cmdInsert As New SqlClient.SqlCommand()
        Dim rdrInsert As SqlClient.SqlDataReader
        Dim AplicaDescuentoFijo As String
        Dim Valida As Int16 = Nothing

        cmdInsert.Connection = SqlConnection
        cmdInsert.CommandTimeout = 30
        cmdInsert.CommandText = "select IsNull(Valor,'0') as Valor from Parametro where Modulo=1 and Parametro='DESCUENTODIRECTO'"
        cmdInsert.Parameters.Clear()
        rdrInsert = cmdInsert.ExecuteReader
        If rdrInsert.Read() Then
            AplicaDescuentoFijo = CType(rdrInsert("Valor"), String)
        Else
            AplicaDescuentoFijo = "0"
        End If

        rdrInsert.Close()
        cmdInsert.Dispose()

        If AplicaDescuentoFijo = "1" Then
            For i = 0 To lstPrecio2.Items.Count - 1
                cmdInsert.Connection = SqlConnection
                cmdInsert.CommandTimeout = 30
                cmdInsert.CommandText = "select dbo.CCLiqPrecioValido(@Precio) as Valido"
                cmdInsert.Parameters.Clear()
                cmdInsert.Parameters.Add("@Precio", SqlDbType.Money).Value = CType(lstPrecio2.Items(i), Decimal)
                rdrInsert = cmdInsert.ExecuteReader
                rdrInsert.Read()

                If CType(rdrInsert("Valido"), Integer) = 0 Then
                    _PrecioMalo = CType(lstPrecio2.Items(i), String)
                    Regreso = True
                End If
                rdrInsert.Close()
            ...
            For i = 0 To lstPrecio.Items.Count - 1
                ...
                cmdInsert.CommandText = "select dbo.CCLiqPrecioValido(@Precio) as Valido"
                cmdInsert.Parameters.Clear()
                cmdInsert.Parameters.Add("@Precio", SqlDbType.Money).Value = CType(lstPrecio.Items(i), Decimal)
                rdrInsert = cmdInsert.ExecuteReader
                rdrInsert.Read()
    ...
    Private Sub KeyDownRemision2(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)

        If CType(sender, TextBox).Name.Substring(0, 4) = "txtR" Then
            If ((e.KeyCode = 38 And CType(CType(sender, TextBox).Tag, Integer) <> 0) Or (e.KeyCode = 39) Or (e.KeyCode = 40 And CType(CType(sender, TextBox).Tag, Integer) <> 59)) Then
                ...
                For Each Paneles In pnPedidos.Controls
                    ...
                    If Paneles.Name.Substring(0, 4) = "txtR" And CType(Paneles.Tag, Integer) = CType(CType(sender, TextBox).Tag, Integer) - 1 And e.KeyCode = 38 Then
                        Paneles.Focus()
                    End If

                    If Paneles.Name.Substring(0, 4) = "txtR" And CType(Paneles.Tag, Integer) = CType(CType(sender, TextBox).Tag, Integer) + 1 And e.KeyCode = 40 Then
                        Paneles.Focus()
                    End If
                    ...
                    Try
                        ...
                        For i = 0 To lstNotas.Items.Count - 1
                            If CType(lstNotas.Items(i), String) = CType(CType(sender, TextBox).Text, String) And i <> CType(CType(sender, TextBox).Tag, Integer) Then
                                MsgBox("Esta remisión ya la capturo. Verifique", MsgBoxStyle.Exclamation, "Mensaje del sistema")
                                CType(sender, TextBox).Select()
                                Exit Sub
                            End If
                        Next

                        For i = 0 To lstRemision.Items.Count - 1
                            If CType(lstRemision.Items(i), String) = CType(sender, TextBox).Text Then
                                MsgBox("Esta remisión esta capturada en la parte de arriba, Verifique.", MsgBoxStyle.Exclamation, "Mensaje del sistema")
                                CType(sender, TextBox).Select()
                                Exit Sub
                            End If
                        Next
    ...
    Private Function ValidarNumeroNota3() As Boolean
        Dim i As Integer
        Dim Regreso As Boolean
            ...
            If CType(lstLitros2.Items(i), String) <> "0" Then
                If CType(lstClientes2.Items(i), String) <> "0" Then
                    If CType(lstForma2.Items(i), String) = "CONTADO" Then
                        If ((CType(lstNotas.Items(i), String) <> "") And (CType(lstNotas.Items(i), String) <> "0")) Then
                            Regreso = True
                            Exit For
                        End If
                    End If
            ...
            If CType(lstLitros2.Items(i), String) <> "0" Then
                If CType(lstClientes2.Items(i), String) <> "0" Then
                    If CType(lstForma2.Items(i), String) = "CREDITO" Then
                        If ((CType(lstNotas.Items(i), String) = "") Or (CType(lstNotas.Items(i), String) = "0")) Then
                            Regreso = True
                            Exit For
                        End If
                    End If
    ...
    Private Function ValidarNumeroNota4() As Boolean
        Dim i As Integer
        Dim Regreso As Boolean
        ...
        For i = 0 To lstLitros.Items.Count - 1
            If CType(lstLitros.Items(i), String) <> "0" Then
                If CType(lstForma.Items(i), String) = "CONTADO" Then
                    If ((CType(lstRemision.Items(i), String) <> "") And (CType(lstRemision.Items(i), String) <> "0")) Then
                        Regreso = True
                        Exit For
                    End If
    ...
    Private Function ValidarNumeroNota2() As Boolean
        Dim i As Integer
        Dim Regreso As Boolean
        ...
        For i = 0 To lstLitros.Items.Count - 1
            If CType(lstLitros.Items(i), String) <> "0" Then
                If CType(lstForma.Items(i), String) = "CREDITO" Then
                    If ((CType(lstRemision.Items(i), String) = "") Or (CType(lstRemision.Items(i), String) = "0")) Then
                        Regreso = True
                        Exit For
                    End If
        ...
        Try
            ...
            For Each Paneles In pnPedidos.Controls
                If Paneles.Name.Substring(0, 4) = "txtL" Then
                    'TODO: Desactivado temporalmente para permitir modificar litros (BUENA)
                    CType(Paneles, System.Windows.Forms.TextBox).ReadOnly = False
            ...
            If DsLiquidacion.Pedido.Count > 0 Then
                ...
                'cmdInsert.Parameters.Add("@Folio", SqlDbType.Int).Value = DsLiquidacion.Operador(0).Folio
                'End If
                cmdInsert.CommandText = "EXECUTE spCCLIQConsultaRampacRemisiones " & _
                   CStr(DsLiquidacion.Operador(0).AñoAtt) & ", " & CStr(DsLiquidacion.Operador(0).Folio)
                        ...
                        If CType(lstClientes.Items(i), Integer) = CType(rdrInsert("Cliente"), Integer) Then
                            ...
                            For Each Paneles In pnPedidos.Controls
                                ...
                                If Paneles.Name.Substring(0, 4) = "cmbF" And CType(Paneles.Tag, Integer) = i Then
                                    If Trim(CType(rdrInsert("FormaPago"), String)) = "Contado" Then
            ...
            'DESACTIVADO EL 06/05/2005 JAGD, SE CODIFICÓ EN PROCEDIMIENT ALMACENADO 
            'If _Celula <> 6 Then
            '    cmdInsert.CommandText = " SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED " & _
            ...
            'cmdInsert.Parameters.Add("@Folio", SqlDbType.Int).Value = DsLiquidacion.Operador(0).Folio
            'End If
            cmdInsert.CommandText = "EXECUTE spCCLIQConsultaRampacNotasBlancas " & _
               CStr(DsLiquidacion.Operador(0).AñoAtt) & ", " & CStr(DsLiquidacion.Operador(0).Folio)
            rdrInsert = cmdInsert.ExecuteReader()
            i = 0
            While rdrInsert.Read
                ...
                For Each Paneles In pnNotas.Controls
                    ...
                    If Paneles.Name.Substring(0, 5) = "cmbNF" And CType(Paneles.Tag, Integer) = i And ExisteCliente = True Then
                        'TODO: Trim al valor del datareader

                        'Para ordenar las liquidaciones por tipo de pago
                        If Trim(CType(rdrInsert("FormaPago"), String)) <> "Contado" Then
                            Paneles.Text = "CREDITO"
                        Else
                            Paneles.Text = "CONTADO"
    ...
    Private Sub SelectedIndexChanged1(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If CType(sender, ComboBox).Text = "Credito Empresa" Then
            Try
                cmdInsert.Connection = SqlConnection
    ...
    Private Sub Proc(ByVal Tipo As Integer, ByVal tag As Integer, ByVal Combo As ComboBox)
        ...
        Else
            ...
            Combo.Items.Add("Credito Empresa")
    ...
    Private Sub ValidatedRemision(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim cmdInsert As New SqlClient.SqlCommand()
        Dim rdrInsert As SqlClient.SqlDataReader
        Dim Registro As Integer
        Dim i As Integer
        ...
        If CType(sender, TextBox).Text <> "" And CType(sender, TextBox).Text <> "0" Then
            Try
                cmdInsert.Connection = SqlConnection
                cmdInsert.CommandTimeout = 30
                cmdInsert.CommandType = CommandType.Text
                'cmdInsert.CommandText = "Select Count(*) as Registro from Pedido where SerieRemision=@Serie and Remision=@Remision "
                cmdInsert.CommandText = "EXEC spCCLIQValidaRemision " & CType(CType(sender, TextBox).Text, String) & ", " & _
                   CType(_Ruta, String)
                cmdInsert.Parameters.Clear()
                'cmdInsert.Parameters.Add("@Serie", SqlDbType.Char).Value = Global_SerieRemision
                'cmdInsert.Parameters.Add("@Remision", SqlDbType.Int).Value = CType(CType(sender, TextBox).Text, Integer)
                rdrInsert = cmdInsert.ExecuteReader
                rdrInsert.Read()
                Registro = CType(rdrInsert("Registro"), Integer)
                rdrInsert.Close()
            ...
            If Registro > 0 Then
                MsgBox("Esta remisión ya fue utilizada anteriormente, Verifique.", MsgBoxStyle.Exclamation, "Mensaje del sistema")
                CType(sender, TextBox).Select()
                Exit Sub
            End If
            ...
            If CType(sender, TextBox).Text <> "0" Then
                For i = 0 To lstRemision.Items.Count - 1
                    If CType(lstRemision.Items(i), String) = CType(sender, TextBox).Text And i <> CType(CType(sender, TextBox).Tag, Integer) Then
                        MsgBox("Esta remision ya fue capturada. Verifique", MsgBoxStyle.Exclamation, "Mensaje del sistema")
                        CType(sender, TextBox).Select()
                        Exit Sub
                    End If
                Next
                ...
                For i = 0 To lstNotas.Items.Count - 1
                    If CType(lstNotas.Items(i), String) = CType(sender, TextBox).Text Then
                        MsgBox("Esta remision esta capturada en la parte de abajo, Verifique.", MsgBoxStyle.Exclamation, "Mensaje del sistema")
                        CType(sender, TextBox).Select()
                        Exit Sub
                    End If
                Next
    ...
    Private Sub ValidatedRemision2(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim cmdInsert As New SqlClient.SqlCommand()
        Dim rdrInsert As SqlClient.SqlDataReader
        Dim Registro As Integer
        Dim i As Integer
        'TODO: Permitir borrar filas erróneas en la liquidación
        'If IsNumeric(CType(sender, TextBox).Text) = False Then
        '    CType(sender, TextBox).Text = "0"
        'End If
            ...
            If CType(Paneles.Tag, Integer) = CType(CType(sender, TextBox).Tag, Integer) Then
                ...
                If Paneles.Name.Substring(0, 5) = "txtNL" Then
                    ...
                    If Paneles.Text = "0" Then
                        CType(Paneles, System.Windows.Forms.TextBox).ReadOnly = False
                    Else
                        'TODO: Desactivado temporalmente para permitir captura de litros en la liquidacion (buENA)
                        CType(Paneles, System.Windows.Forms.TextBox).ReadOnly = False
                    End If
        ...
        If CType(sender, TextBox).Text <> "" And CType(sender, TextBox).Text <> "0" Then
            ...
            If CType(sender, TextBox).Text <> "0" Then
                ...
                For i = 0 To lstRemision.Items.Count - 1
                    If CType(lstRemision.Items(i), String) = CType(sender, TextBox).Text Then
                        MsgBox("Esta remision esta capturada en la parte de arriba, Verifique.", MsgBoxStyle.Exclamation, "Mensaje del sistema")
                        CType(sender, TextBox).Select()
                        Exit Sub
                    End If
                Next
    ...
    Private Sub ValidatedCliente(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If CType(sender, TextBox).Text <> "" Then
            ...
            'Modifico MHV mejora de permitir capturar un mismo cliente en la liquidacion. 28/10/2004 14:25 pm
            'TODO: Captura de múltiples contratos reactivada el 27112004
    ...
    Private Sub TextChanged1(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For Each Paneles In pnPedidos.Controls
            If Paneles.Name <> "" Then
                ...
                If Paneles.Name.Substring(0, 4) = "txtR" Then
                    If IsNumeric(Paneles.Text) = True Then
                        lstRemision.Items.Add(Paneles.Text)
                    Else
                        lstRemision.Items.Add("0")
                    End If
                End If
    ...
    Private Sub TextChanged3(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Trim(DirectCast(sender, ComboBox).Text) = "CREDITO" Then
    ...
    Private Sub CargarGrid2()
        ...
        AddHandler txtNNota0.Enter, AddressOf EntradaGrid2
        AddHandler txtNCliente0.Enter, AddressOf EntradaGrid2
        AddHandler txtNLitros0.Enter, AddressOf EntradaGrid2
        AddHandler txtNPrecio0.Enter, AddressOf EntradaGrid2
        ...
        AddHandler txtNNota0.Validated, AddressOf ValidatedRemision2
        ...
        For i = 1 To 100
            ...
            AddHandler EtiquetasNota.Validated, AddressOf ValidatedRemision2
            ...
            EtiquetasNombre.Size = New Size(227, 21)
            ...
            EtiquetasLitros.Location = New Point(464, Alto)
            ...
            EtiquetasPrecio.Location = New Point(514, Alto)
            ...
            EtiquetasImporte.Location = New Point(570, Alto)
            ...
            EtiquetasForma.Location = New Point(650, Alto)
            ...
            EtiquetasTipo.Location = New Point(731, Alto)
    ...
    Private Sub CargarGrid()
        ...
        AddHandler txtRemision0.Enter, AddressOf EntradaGrid1
        ...
        AddHandler txtRemision0.KeyPress, AddressOf MyKeyPress2
        AddHandler txtRemision0.TextChanged, AddressOf TextChanged1
        AddHandler txtRemision0.Validated, AddressOf ValidatedRemision
        ...
        If DsLiquidacion.Pedido.Count > 1 Then
            For i = 1 To DsLiquidacion.Pedido.Count - 1
                ...
                Dim EtiquetasRemision As TextBox = New TextBox()
                EtiquetasRemision.Name = "txtRemision" + CType(i, String)
                EtiquetasRemision.Visible = True
                EtiquetasRemision.TextAlign = HorizontalAlignment.Right
                EtiquetasRemision.Text = "0"
                EtiquetasRemision.MaxLength = 12
                EtiquetasRemision.CharacterCasing = CharacterCasing.Upper
                EtiquetasRemision.BackColor = Color.White
                EtiquetasRemision.Size = New Size(97, 21)
                EtiquetasRemision.BorderStyle = BorderStyle.FixedSingle
                EtiquetasRemision.Location = New Point(359, Alto)
                EtiquetasRemision.BringToFront()
                EtiquetasRemision.Tag = i
                AddHandler EtiquetasRemision.Enter, AddressOf EntradaGrid1
                AddHandler EtiquetasRemision.KeyPress, AddressOf MyKeyPress2
                AddHandler EtiquetasRemision.TextChanged, AddressOf TextChanged1
                AddHandler EtiquetasRemision.Validated, AddressOf ValidatedRemision
                AddHandler EtiquetasRemision.KeyDown, AddressOf KeyDownRemision2
                pnPedidos.Controls.Add(EtiquetasRemision)
                ...
                EtiquetasLitros.Size = New Size(51, 21)
                EtiquetasLitros.BorderStyle = BorderStyle.FixedSingle
                EtiquetasLitros.Location = New Point(456, Alto)
                EtiquetasLitros.BringToFront()
                EtiquetasLitros.Tag = i
                ...
                EtiquetasPrecio.Size = New Size(57, 21)
                EtiquetasPrecio.BorderStyle = BorderStyle.FixedSingle
                EtiquetasPrecio.Location = New Point(507, Alto)
                ...
                EtiquetasImporte.Size = New Size(80, 21)
                EtiquetasImporte.BorderStyle = BorderStyle.FixedSingle
                EtiquetasImporte.Location = New Point(563, Alto)
                EtiquetasImporte.BringToFront()
                EtiquetasImporte.Tag = i
                ...
                EtiquetasForma.BackColor = Color.White
                EtiquetasForma.Size = New Size(83, 21)
                EtiquetasForma.Location = New Point(643, Alto)
                EtiquetasForma.DropDownStyle = ComboBoxStyle.DropDownList
                EtiquetasForma.Tag = i
                EtiquetasForma.Items.Add("CONTADO")
                EtiquetasForma.Items.Add("CREDITO")
                ...
                EtiquetasTipo.BackColor = Color.White
                EtiquetasTipo.Size = New Size(120, 21)
                EtiquetasTipo.Location = New Point(724, Alto)
                EtiquetasTipo.DropDownStyle = ComboBoxStyle.DropDownList
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txtRemision0 As System.Windows.Forms.TextBox
    Friend WithEvents Label32 As System.Windows.Forms.Label
    Friend WithEvents Label35 As System.Windows.Forms.Label
    Friend WithEvents lstRemision As System.Windows.Forms.ListBox
    Friend WithEvents btnCalc As System.Windows.Forms.Button
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(LiquidacionRemision))
        ...
        Me.txtRemision0 = New System.Windows.Forms.TextBox()
        ...
        Me.lstRemision = New System.Windows.Forms.ListBox()
        ...
        Me.btnImprimir.Location = New System.Drawing.Point(912, 136)
        ...
        Me.btnCancelar.Location = New System.Drawing.Point(912, 72)
        ...
        Me.btnAceptar.Location = New System.Drawing.Point(912, 40)
        ...
        Me.Panel1.Size = New System.Drawing.Size(872, 24)
        ...
        Me.Label3.Size = New System.Drawing.Size(872, 24)
        ...
        Me.pnPedidos.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtRemision0, Me.txtLitros0, Me.lbImporte0, Me.txtPrecio0, Me.lbCliente0, Me.cmbTipo0, Me.lbNombre0, Me.cmbForma0, Me.lbPedido0})
        ...
        Me.pnPedidos.Size = New System.Drawing.Size(872, 182)
        Me.pnPedidos.TabIndex = 0
        '
        'txtRemision0
        '
        Me.txtRemision0.BackColor = System.Drawing.Color.White
        Me.txtRemision0.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.txtRemision0.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.txtRemision0.Location = New System.Drawing.Point(359, 3)
        Me.txtRemision0.MaxLength = 12
        Me.txtRemision0.Name = "txtRemision0"
        Me.txtRemision0.Size = New System.Drawing.Size(97, 21)
        Me.txtRemision0.TabIndex = 8
        Me.txtRemision0.Tag = ""
        Me.txtRemision0.Text = "0"
        Me.txtRemision0.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
        '
        'txtLitros0
        '
        ...
        Me.txtLitros0.Location = New System.Drawing.Point(456, 3)
        ...
        Me.lbImporte0.Location = New System.Drawing.Point(563, 3)
        ...
        Me.txtPrecio0.Location = New System.Drawing.Point(507, 3)
        ...
        Me.cmbTipo0.Location = New System.Drawing.Point(724, 3)
        ...
        Me.lbNombre0.Location = New System.Drawing.Point(159, 3)
        ...
        Me.cmbForma0.Location = New System.Drawing.Point(643, 3)
        ...
        'Panel2
        '
        Me.Panel2.Controls.AddRange(New System.Windows.Forms.Control() {Me.Label35, Me.Label32, Me.Label12, Me.Label11, Me.Label10, Me.Label9, Me.Label8, Me.Label7, Me.Label6, Me.Label5, Me.Label4})
        ...
        Me.Label35.Location = New System.Drawing.Point(728, 0)
        Me.Label35.Name = "Label35"
        Me.Label35.Size = New System.Drawing.Size(120, 24)
        Me.Label35.TabIndex = 10
        Me.Label35.Text = "Pago"
        ...
        Me.Label32.Location = New System.Drawing.Point(648, 0)
        ...
        Me.Label12.Location = New System.Drawing.Point(648, 0)
        Me.Label12.Name = "Label12"
        Me.Label12.Size = New System.Drawing.Size(224, 24)
        ...
        Me.Label11.Location = New System.Drawing.Point(568, 0)
        ...
        Me.Label10.Location = New System.Drawing.Point(512, 0)
        ...
        Me.Label9.Text = "Litros"
        Me.Label9.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
        '
        'Label8
        '
        Me.Label8.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.Label8.Location = New System.Drawing.Point(496, 0)
        ...
        Me.lbTotalLitros1.Location = New System.Drawing.Point(434, 267)
        ...
        Me.lbTotalImporte1.Location = New System.Drawing.Point(562, 267)
        ...
        Me.Panel3.Size = New System.Drawing.Size(872, 24)
        ...
        Me.Label13.Size = New System.Drawing.Size(872, 24)
        ...
        Me.Panel4.Size = New System.Drawing.Size(872, 24)
        ...
        Me.Label15.Location = New System.Drawing.Point(728, 0)
        ...
        Me.Label16.Location = New System.Drawing.Point(648, 0)
        ...
        Me.Label17.Location = New System.Drawing.Point(568, 0)
        ...
        Me.Label18.Location = New System.Drawing.Point(520, 0)
        ...
        Me.Label19.Location = New System.Drawing.Point(464, 0)
        ...
        Me.Label24.Size = New System.Drawing.Size(224, 24)
        ...
        Me.Label14.Size = New System.Drawing.Size(632, 24)
        ...
        Me.pnNotas.Size = New System.Drawing.Size(872, 186)
        ...
        Me.lbNNombre0.Size = New System.Drawing.Size(227, 21)
        ...
        Me.txtNLitros0.Location = New System.Drawing.Point(464, 3)
        ...
        Me.lbNImporte0.Location = New System.Drawing.Point(570, 3)
        ...
        Me.txtNPrecio0.Location = New System.Drawing.Point(514, 3)
        ...
        Me.cmbNTipo0.Location = New System.Drawing.Point(731, 3)
        ...
        Me.cmbNForma0.Location = New System.Drawing.Point(650, 3)
        ...
        Me.lstForma.Location = New System.Drawing.Point(916, 376)
        ...
        Me.lstPrecio.Location = New System.Drawing.Point(933, 472)
        ...
        Me.lstLitros.Location = New System.Drawing.Point(912, 376)
        ...
        Me.lstClientes.Location = New System.Drawing.Point(917, 424)
        ...
        Me.lstPedido.Location = New System.Drawing.Point(916, 424)
        ...
        Me.dgPago.CaptionText = "Documentos"
        ...
        Me.dgPago.Location = New System.Drawing.Point(904, 232)
        ...
        Me.dgPago.Size = New System.Drawing.Size(120, 304)
        ...
        Me.dgctPago.HeaderFont = New System.Drawing.Font("Tahoma", 6.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lstTipoPago.Location = New System.Drawing.Point(916, 472)
        ...
        Me.lstPedido2.Size = New System.Drawing.Size(32, 43)
        ...
        Me.lstPrecio2.Location = New System.Drawing.Point(144, 600)
        ...
        Me.pnTotales.Location = New System.Drawing.Point(608, 544)
        ...
        Me.btnDocumento.Location = New System.Drawing.Point(912, 104)
        Me.btnDocumento.Name = "btnDocumento"
        Me.btnDocumento.Size = New System.Drawing.Size(96, 23)
        ...
        Me.lstNotasBlancas.Location = New System.Drawing.Point(924, 256)
        ...
        Me.btnBuscar.Location = New System.Drawing.Point(912, 168)
        ...
        Me.btnBuscarCliente.Location = New System.Drawing.Point(912, 200)
        Me.btnBuscarCliente.Name = "btnBuscarCliente"
        Me.btnBuscarCliente.Size = New System.Drawing.Size(96, 23)
        ...
        Me.ListBox5.Location = New System.Drawing.Point(128, 624)
        ...
        'lstRemision
        '
        Me.lstRemision.BackColor = System.Drawing.SystemColors.Info
        Me.lstRemision.Location = New System.Drawing.Point(776, 216)
        Me.lstRemision.Name = "lstRemision"
        Me.lstRemision.Size = New System.Drawing.Size(88, 82)
        Me.lstRemision.TabIndex = 81
        Me.lstRemision.Visible = False
        '
        'btnCalc
        '
        Me.btnCalc.Image = CType(resources.GetObject("btnCalc.Image"), System.Drawing.Bitmap)
        Me.btnCalc.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft
        Me.btnCalc.Location = New System.Drawing.Point(24, 552)
        Me.btnCalc.Name = "btnCalc"
        Me.btnCalc.Size = New System.Drawing.Size(88, 23)
        Me.btnCalc.TabIndex = 82
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnCalc, Me.lstRemision, Me.btnBuscarCliente, Me.dgPago, Me.lbUnificacion, Me.btnBuscar, Me.Button1, Me.txtFolio, Me.lstNotasBlancas, Me.btnDocumento, Me.pnTotales, Me.lstNotas, Me.lstTipoPago2, Me.lstPedido2, Me.lstClientes2, Me.lstLitros2, Me.lstPrecio2, Me.lstForma2, Me.lstTipoPago, Me.btnImprimir, Me.btnCancelar, Me.btnAceptar, Me.lstPedido, Me.lstClientes, Me.lstLitros, Me.lstPrecio, Me.lstForma, Me.Label34, Me.Label29, Me.Label26, Me.lbAutotanque, Me.lbOperador, Me.Label2, Me.Label1, Me.lbTotalImporte, Me.lbTotalLitros, Me.lbTotalCredito, Me.lbLitrosCredito, Me.lbTotalContado, Me.lbLitrosContado, Me.lbTotalNotas, Me.lbLitrosNotas, Me.pnNotas, Me.Panel4, Me.Panel3, Me.lbTotalImporte1, Me.lbTotalLitros1, Me.lbFecha, Me.Panel2, Me.pnPedidos, Me.Panel1, Me.ListBox3, Me.ListBox1, Me.ListBox2, Me.ListBox4, Me.ListBox5, Me.ListBox6, Me.ListBox7, Me.ListBox8})
        Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.Icon = CType(resources.GetObject("$this.Icon"), System.Drawing.Icon)
        Me.Menu = Me.MainMenu1
        Me.Name = "LiquidacionRemision"
...
#End Region
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        Try
            num = CType(lbTotalLitros.Text, Decimal)
        Catch exNum As Exception
            lbTotalLitros.Text = "0"
        End Try

        'If _Totalizador <> CType(lbTotalLitros.Text, Decimal) Then
        'TODO: Para evitar que muestre mensaje de litros incongruentes entre totalizador y liquidación
        'se convirtió a integer el valor de lbTotalLitros.text JAGD Flama 26-11-2004
        If _Totalizador <> CType(lbTotalLitros.Text, Double) Then
            If MsgBox("El litraje a liquidar es DIFERENTE al TOTALIZADOR de la bascula." + Chr(13) + "El litraje a liquidar es de : " + CType(CType(lbTotalLitros.Text, Decimal), String) + " litros." + Chr(13) + "El litraje del totalizador de la bascula es : " + CType(_Totalizador, String) + " litros." + Chr(13) + Chr(13) + "Aun asi ¿Desea realizar la liquidación?.", MsgBoxStyle.YesNoCancel, "Mensaje del sistema") <> MsgBoxResult.Yes Then
                cn.Close()
                Exit Sub
            End If
        End If

        If ValidarNumeroNota3() = True Then
            cn.Close()
            MsgBox("Existe un registro de nota blanca CONTADO con litraje mayor a cero que se le capturo un numero de remisión. Verifique", MsgBoxStyle.Exclamation, "Mensaje del sistema")
            Exit Sub
        End If

        If ValidarNumeroNota4() = True Then
            cn.Close()
            MsgBox("Existe un registro de remision de CONTADO con litraje mayor a cero que se le capturo un numero de remisión . Verifique", MsgBoxStyle.Exclamation, "Mensaje del sistema")
            Exit Sub
        End If

        If ValidarPrecios() = True Then
            cn.Close()
            MsgBox("Existe capturado un precio en el sistema que no es valido. No es el precio vigente, el precio anterior vigente o un precio valido con descuento. PRECIO ERRONEO : " + _PrecioMalo, MsgBoxStyle.Exclamation, "Mensaje del sistema")
            Exit Sub
        End If

        If ValidarNumeroNota() = True Then
            cn.Close()
            MsgBox("Existe un registro de nota blanca CREDITO con litraje mayor a cero que no se le ha capturado su numero de remisión. Verifique", MsgBoxStyle.Exclamation, "Mensaje del sistema")
            Exit Sub
        End If

        If ValidarNumeroNota2() = True Then
            cn.Close()
            MsgBox("Existe un registro de remision de CREDITO con litraje mayor a cero que no se le ha capturado su numero de remisión . Verifique", MsgBoxStyle.Exclamation, "Mensaje del sistema")
            Exit Sub
        End If
        ...
        Try
            ...
            For i = 0 To lstPedido.Items.Count - 1
                If CType(lstLitros.Items(i), Decimal) > 0 Then
                    cmdInsert.CommandType = CommandType.StoredProcedure
                    ...
                    cmdInsert.Parameters.Add("@Codigo", SqlDbType.Char).Value = CType(lstRemision.Items(i), String)
                    'TODO: Desactivada la inclusión de decimales
                    'cmdInsert.Parameters.Add("@Litros", SqlDbType.Decimal).Value = CType(lstLitros.Items(i), Decimal)
                    cmdInsert.Parameters.Add("@Litros", SqlDbType.Decimal).Value = CType(lstLitros.Items(i), Double)
                    cmdInsert.Parameters.Add("@Precio", SqlDbType.Decimal).Value = CType(lstPrecio.Items(i), Decimal)
                    'TODO: Porque 2 Parametros para el precio?
                    'cmdInsert.Parameters.Add("@Precio", SqlDbType.Decimal).Value = CType(lstPrecio.Items(i), Decimal)
                    ...
                    Else
                        ...
                        Else
                            If CType(lstTipoPago.Items(i), String) = "Credito Empresa" Then
            ...
            For i = 0 To lstNotas.Items.Count - 1
                If RTrim(CType(lstNotas.Items(i), String)) <> "" And CType(lstLitros2.Items(i), Decimal) > 0 Then
                    cmdInsert.CommandType = CommandType.StoredProcedure
                    cmdInsert.CommandText = "sp_LiquidacionMaestra"
                    cmdInsert.Parameters.Clear()
                    cmdInsert.Parameters.Add("@AñoAtt", SqlDbType.Int).Value = DsLiquidacion.Operador(0).AñoAtt
                    ...
                    'cmdInsert.Parameters.Add("@Codigo", SqlDbType.Char).Value = _
                    '    IIf(Len(CType(lstNotas.Items(i), String)) > 0, CType(lstNotas.Items(i), String), "0")
                    'TODO: Desactivación de la inclusión de decimales en la liquidación 27/11/2004
                    'cmdInsert.Parameters.Add("@Litros", SqlDbType.Decimal).Value = CType(lstLitros2.Items(i), Decimal)
                    cmdInsert.Parameters.Add("@Litros", SqlDbType.Decimal).Value = CType(lstLitros2.Items(i), Double)
                    ...
                    Else
                        If CType(lstTipoPago2.Items(i), String) = "Tarjeta credito" Then
                            cmdInsert.Parameters.Add("@Tipo", SqlDbType.Int).Value = 6
                        Else
                            If CType(lstTipoPago2.Items(i), String) = "Credito Empresa" Then
            ...
            cmdInsert.Parameters.Add("@LitrosContado", SqlDbType.Decimal).Value = CType(lbLitrosContado.Text, Double)
            ...
            'Application.DoEvents 
            'If Not (rdrInsert.IsClosed) Then
            '    rdrInsert.Close()
            'End If
        Catch et As Data.SqlClient.SqlException
            ...
            'TODO: Este datareader no se utiliza, por lo que se eliminó su declaración
            'rdrInsert.Close()
            'cn.Close()
    ...
    Private Sub btnDocumento_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDocumento.Click
        ...
        For i = 0 To DsLiquidacion.Cliente.Count - 1
            'frmRelacion.DsLiquidacion.Cliente.AddClienteRow(DsLiquidacion.Cliente(i).Monto, DsLiquidacion.Cliente(i).Nombre, DsLiquidacion.Cliente(i).Disponible, DsLiquidacion.Cliente(i).Cliente, 0)
        Next

        For i = 0 To lstClientes.Items.Count - 1
            Encontro = False
            If CType(lstLitros.Items(i), Decimal) <> 0 And CType(lstForma.Items(i), String) = "CONTADO" Then
        ...
        For i = 0 To lstClientes2.Items.Count - 1
            Encontro = False
            If CType(lstLitros2.Items(i), Decimal) <> 0 And CType(lstClientes2.Items(i), Integer) <> 0 And CType(lstForma2.Items(i), String) = "CONTADO" Then
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        If Litros > 0 Then
            ...
            If Panel = 1 Then
                For Each Paneles In pnPedidos.Controls
                    If Paneles.Name.Substring(0, 4) = "txtL" Then
                        If CType(Paneles.Text, Decimal) = Litros Then
