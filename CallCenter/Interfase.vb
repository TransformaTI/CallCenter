...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmInterfase))
        ...
        Me.ComboRuta1 = New SigaMetClasses.Combos.ComboRuta()
        ...
        Me.Name = "frmInterfase"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Interfase con el dispositivo Rampac"
...
#End Region
            ...
            Try
                ...
                While sr.Peek > -1
                    ...
                    If Len(strLinea) = 148 Then 'Solo leo las lineas que tengan el largo de 148 caracteres
                        ...
                        'Cambio hecho el 14 de febrero del 2005
                        strError = " Archivo  " & Path.GetFileName(File1.FileName.ToUpper) & "  mal generado" & Chr(13) & _
                                   " Carácteres no válidos en línea: " & CStr(TotalReg) & Chr(13) & _
                                   " (" & Mid(strLinea, 1, 74) & Chr(13) & " " & Mid(strLinea, 75, 148) & _
                                   ")" & Chr(13) & Chr(13) & _
                                   " Deberá realizar la Liquidación de forma MANUAL." & Chr(13) & Chr(13)
                        ...
                        If TipoOperacion <> "a" And TipoOperacion <> "0" And Cliente <> "9999999999" Then
                            ...
                            'Cambio hecho el 14 de febrero del 2005
                            If Not IsNumeric(Mid(strLinea, 118, 1)) Or _
                               Not IsNumeric(Mid(InfoOperacion, 10, 7)) Or _
                               Not IsNumeric(Mid(InfoOperacion, 17, 7)) Then
                                MessageBox.Show(strError, Titulo, MessageBoxButtons.OK, MessageBoxIcon.Error)
                                Exit Sub
                            End If
    ...
    Private Sub ComboCelula1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboCelula1.SelectedIndexChanged
        ComboRuta1.CargaDatos(, CType(ComboCelula1.Celula, Byte))
        _Autotanque = 0
    ...
    Private Sub ComboCelula_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboCelula.SelectedIndexChanged
        ComboRuta.Text = ""
        ComboRuta.CargaDatos(, CType(ComboCelula.Celula, Byte))
    End Sub
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        Dim strEncabezado As String = "", strLinea As String = "", strRuta As String = ""
